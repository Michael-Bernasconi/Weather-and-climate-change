...
The project's domain of interest is defined by precise spatial and temporal boundaries, specifically selected to enable the monitoring and study of meteorological phenomena in a mountainous context. Geographically, the domain is strictly deliminated to the territory of the Autonomous Province of Trento (Trentino region). This area, ranging from valley floors to alpine peaks, provides a heterogeneous environment suitable for analyzing diverse microclimatic conditions.
