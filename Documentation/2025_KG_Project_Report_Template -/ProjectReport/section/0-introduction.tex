...
\begin{itemize}
    ...
    \item Sections 3, 4, 5, and 6 describe the phases of the iTelos process and their corresponding activities, distinguishing between knowledge-layer and data-layer tasks, and include an evaluation of the produced resources with respect to their fitness for the intended purpose.
    
    \item Section 7 describes the metadata generated for all types of resources handled and produced during the execution of the iTelos process.
    
    \item Section 8 concludes the report and summarizes the identified open issues.
\end{itemize}
