...
\begin{itemize}
    \item \textbf{Home Weather Ontology}:
    \item \textbf{Schema.org}:
    \item \textbf{DCAT}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{ilMeteo.it}: \href{https://www.ilmeteo.it/portale/archivio-meteo/Trento}{ilMeteo.it} gives access to historical weather data for Trento. 
    \item \textbf{Historical Weather API}:
\end{itemize}