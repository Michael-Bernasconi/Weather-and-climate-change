...
Following the information gathering phase, the previously defined personas, scenarios, and Competency Questions (CQs) were reviewed. It was concluded that no modifications were required, as the available resources are sufficient to cover the entire domain of interest. Some data, such as seasons, microclimates, and anomalies, need to be derived from the available datasets. The procedures adopted to generate these data are described in the next section. è tutto scritto in modo impersonale?