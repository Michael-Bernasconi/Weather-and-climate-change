...
\begin{itemize}
    ...
    \item \textbf{\href{https://earthportal.eu/ontologies/SWEET}{SWEET Ontology}} (Semantic Web for Earth and Environmental Terminology) is a comprehensive semantic framework originally developed by NASA JPL and currently maintained by the Earth Science Information Partners (ESIP). 
    It provides a highly modular and extensible set of ontologies covering a vast range of Earth system science concepts, including the atmosphere, hydrosphere, solid earth, and associated physical properties (such as time, space, and units of measure).
    In the context of this project, SWEET is leveraged to provide the rigorous scientific grounding required for modeling complex atmospheric phenomena and climatic processes. 
    It is specifically used to define high-level concepts such as \textit{Microclimate}, \textit{AtmosphericPhenomena}, and physical properties like \textit{Temperature} and \textit{Precipitation}, ensuring that the Knowledge Graph adheres to the terminological standards used by the global scientific research community.
