...
After generating RDF-Turtle files, they've been imported in GraphDB and it has been analyzed the quality of the result produced. At first, it has been analyzed the class relationship, in order to find out if they've been modeled as intended. The result is shown on Figure \ref{fig:class_relationship}.
\begin{figure}[h]
    \centering
...
\end{figure}
Then, it has been analyzed the class hierarchy graph. It shows the distribution of the classes on the ontology. It's a bubble chart for which eeach bubble's dimension indicates the number of istances for that class. The result is shown on Figure \ref{fig:class_hierarchy} and confirms that the majority of the istances are related to observation data, directly related to the central entity \textit{WeatherReport}.
\begin{figure}[h]
    \centering
...
\end{figure}
Afterwards, it has been generated different visualization graphs to show how istances of different entities are related. The results are shown on Figure \ref{fig:wr_visualization} for the class weather report, for which an istance has been expanded to shown other class relationships; Figure \ref{fig:anomaly_visualization} for the anomaly class; Figure \ref{fig:microclimate_visualization} for the microclimate class and Figure \ref{fig:season_visualization} for the season class.
\begin{figure}[h]
    \centering
