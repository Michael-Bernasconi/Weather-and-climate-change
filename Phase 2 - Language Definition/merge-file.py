...
# Base directory
base_dir = os.path.expanduser("~/Scaricati/Lavarone")
output_file = os.path.join(base_dir, "Lavarone_2000_2025_clean.csv")
...
for year in years:
    ...
    for file in os.listdir(year_path):
        if file.startswith("Lavarone-") and file.endswith(".csv"):
