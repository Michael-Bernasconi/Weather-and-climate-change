...
# Base directory
base_dir = os.path.expanduser("~/Scaricati/Trento")
output_file = os.path.join(base_dir, "Trento_2000_2025_clean.csv")
...
for year in years:
    ...
    for file in os.listdir(year_path):
        if file.startswith("Trento-") and file.endswith(".csv"):
